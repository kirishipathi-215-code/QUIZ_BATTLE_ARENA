...
## 📌 Repository
[https://github.com/kirishipathi-215-code/QUIZ_BATTLE_ARENA.git](https://github.com/kirishipathi-215-code/QUIZ_BATTLE_ARENA.git)
...
```bash
git clone https://github.com/kirishipathi-215-code/QUIZ_BATTLE_ARENA.git
cd QUIZ_BATTLE_ARENA
```
...
├── main.py        # Python backend utilities
